...
namespace SpaceType
{
    ...
    public  class SpaceTypeInputs : ArgsBase
    
    {
        [Newtonsoft.Json.JsonConstructor]
        
        public SpaceTypeInputs(Overrides @overrides, Dictionary<string, string> modelInputKeys, string gltfKey, string elementsKey, string ifcKey):
